...
```mermaid
gantt
    title Pamoja Roadmap
    dateFormat  YYYY-MM-DD
    axisFormat  %b %Y
    section Foundation Track
    Core platform (identity, channels, messaging, wallet, search, safety) :f1, 2026-09-01, 150d
    Pan-African capabilities (currencies, corridor, languages, data-light) :f2, 2027-08-15, 130d
    section Module Catalog
    Business Module — launch wedge   :b1, 2027-01-01, 80d
    Public launch                    :milestone, m1, 2027-03-20, 0d
    Social Module                    :s1, 2027-08-01, 80d
    Future modules                   :future, 2028-02-01, 60d
```
